...
EMS Flow будет развиваться при наличии спроса и содержательной обратной связи. Планируемые направления, включая единый поиск по репликам и маршрутам, опубликованы в [дорожной карте](ROADMAP.md). Порядок и состав задач могут меняться после практической проверки и отзывов пользователей.
